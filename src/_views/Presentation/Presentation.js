    ...
    return (
      <div >
       <nav className="level">
          ...
          <div className="level-item has-text-centered moveInDown fadeIn">
      ...
      <div className="media-content has-text-centered" style={{overflow: "hidden"}}>
        <p className="title is-1 moveInRight fadeIn">Hi! I'm Brian!</p>
        <p className="subtitle is-6 moveInLeft fadeIn">I'm a Software Engineer and fullstack Web Developer with a great background in Telecommunications.
